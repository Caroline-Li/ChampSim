...
mkdir -p bin
rm -f bin/champsim
./config.sh bo_percore_hawkeye_final_dyn_cacheline_prefetch_suppression.json
make
...
echo "Cores: 1"
BINARY_NAME="perceptron-no-bo_percore-hawkeye_final_dyn_cacheline_prefetch_suppression-1core"
