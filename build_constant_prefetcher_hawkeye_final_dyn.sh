...
mkdir -p bin
rm -f bin/champsim
./config.sh constant_prefetcher_hawkeye_final_dyn.json
make
...
echo "L2C Prefetcher: constant_prefetcher"
echo "LLC Replacement: hawkeye_final_dyn"
echo "Cores: 1"
BINARY_NAME="perceptron-no-constant_prefetcher-hawkeye_final_dyn-1core"
