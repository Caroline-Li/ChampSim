...
private:
  ...
  void adjust_feature_weights(vector<bool> consensus_vec, RewardType reward_type, State* state, uint32_t action);
...
public:
  ...
  static string getPoolingTypeString(uint32_t pooling_type);
};
