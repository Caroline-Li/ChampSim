...
private:
	...
	int generate_prefetch(uint64_t pc, uint64_t address, uint64_t page, uint32_t offset, vector<uint64_t> &pref_addr, vector<bool>& pref_level, vector<int>& offsets);
	void buffer_prefetch(vector<uint64_t> pref_addr, vector<int>& offsets);
	void issue_prefetch(vector<uint64_t> &pref_addr, vector<bool>& pref_level, vector<int>& offsets);
